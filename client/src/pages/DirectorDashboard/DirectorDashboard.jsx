...
export default function DirectorDashboard() {
  ...
  // Update filtered employees when filterBranch or employees change
  useEffect(() => {
    if (filterBranch && filterBranch !== '') {
      // Filter employees by selected branch
      const employeesInBranch = employees.filter((emp) => emp.branch_code === filterBranch);
      setFilteredEmployees(employeesInBranch);
    } else {
      // Show all employees if no branch is selected or "Tất cả chi nhánh" is selected
      setFilteredEmployees(employees);
    }
  }, [filterBranch, employees]);
        ...
        <>
          ...
          <div className={styles.filterSection}>
            ...
            <div className={styles.filters}>
              ...
              {/* Employee filter with branch dependency */}
              <select
